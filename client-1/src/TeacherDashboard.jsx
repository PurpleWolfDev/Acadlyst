...
export function TeacherDashboard() {
  ...
  const [homeInfo, updateHomeInfo] = useState( [{ label: 'Total Students', value: '0', icon: Users, color: 'bg-blue-500' },
    ...
    { label: 'Total Classes', value: 0, icon: Calendar, color: 'bg-orange-500' }]);
  ...
  const Header = () => (
    <header className="bg-white border-b-2 border-blue-200 px-6 py-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">        {isLoad?<Loader />:null}
      ...
      <VerifyUser />
          ...
          <div className="w-80 border-r border-gray-200 flex flex-col">
            ...
            <div className="p-4 border-b border-gray-200">
              <div className="relative">        {isLoad?<Loader />:null}
