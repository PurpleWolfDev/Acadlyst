...
import { VerifyUser2 } from './VeirfyUser2';
...
export function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    updateLoad(true);
    let url = `https://homebackend-3y7i.onrender.com/loadStudentBatches?token=${data.token}&sId=${data.sId}`;
    fetch(url)
    .then(res => res.json())
    .then(dat => {
      updateLoad(false);
      ...
      <nav className="mt-8 px-4">
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              {settingNav?<Navigate to="/settingsv2" />:null}
        ...
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Welcome back, <span className="text-blue-800">Student</span>
            </h1>
          ...
          <div className="grid gap-4">
            {batches.map((batch) => (
              <div 
                ...
                onClick={() => updateBatchNav("/batch?bId="+batch.bId+"&id="+batch.adminId+"&batch="+batch.name)}
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">{batch.liveStudents.length} students</p>
                  </div>
                  <div className="flex items-center space-x-4">
